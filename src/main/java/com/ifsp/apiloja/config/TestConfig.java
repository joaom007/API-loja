...
public class TestConfig implements CommandLineRunner{
    ...
    public void run(String... args) throws Exception {
        ...
        Order od1 = new Order(null, Instant.parse("2019-06-20T19:53:07Z"), "cartão", "pago", ct1);
        Order od2 = new Order(null, Instant.parse("2019-06-20T19:53:07Z"), "boleto", "cancelado", ct1);
